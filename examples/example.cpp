...
int main() {
  ...
  // To see it in action enter {ip}:18080/hello/{integer_between -2^32 and 100}
  // and you should receive {integer_between -2^31 and 100} bottles of beer!
  ...
  // To see it in action submit {ip}:18080/add/1/2 and you should receive 3
  // (exciting, isn't it)
  ...
  ([](const crow::request &req) {
    ...
    os << "The key 'foo' was "
       << (req.url_params.get("foo") == nullptr ? "not " : "") << "found.\n";
    ...
    // You have to submit something like '/params?count[]=a&count[]=b' to have a
    // list with two values (a and b)
    ...
    // You have to submit something like '/params?mydict[a]=b&mydict[abcd]=42'
    // to have a list of pairs ((a, b) and (abcd, 42))
